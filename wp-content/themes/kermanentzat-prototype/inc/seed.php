...
<section class="content-band content-band--dark"><div class="content-wrap split-grid"><div><h2 class="section-heading">Aurreko ohartarazpenak eta erakundeen erantzuna</h2></div><div class="reading-copy"><p>Kerman hil aurretik baziren jada lokaleko sarreran indarkeriazko porteroek eragindako erasoak eta ohartarazpenak. Gertatutakoaren ondoren, familiak argitu nahi izan zuen administrazioak zer zekien, zer neurri hartu ziren eta erantzukizunik ba ote zegoen.</p><p>2026ko maiatzaren 25ean, Arartekoak Gasteizko Udalari gomendatu zion salaketari berariaz, arrazoituta eta osorik erantzuteko, eta prebentziozko kontrola indartzeko, aisialdiko lokalen segurtasun-baldintzak betetzen direla bermatzeko.</p><p class="lead">Burututako erantzuna ez dela nahikoa iruditzen zaigu. Aurretiazko ohartarazpenak argitzea, egindako jarduketak berrikustea eta antzeko zerbait berriro gerta ez dadin neurriak hartzea lortzeko lanean ari gara.</p></div></div></section>
<section class="content-band content-band--light"><div class="content-wrap split-grid"><div><h2 class="section-heading">Funtsezko kronologia</h2></div><div class="reading-copy"><div class="evidence-list case-timeline">
  ...
  <div class="evidence-row"><strong>2025eko irailaren 30a</strong><p>Instrukzioko epaileak Herri Epaimahaiaren aurrean hilketa edo nahita egindako homizidioagatik epaitzeko zantzuak zeudela iritzi zuen. Ebazpena urriaren hasieran egin zen publiko, eta ez zen irmoa.</p></div>
  ...
  <div class="evidence-row"><strong>2026ko uztailaren 8a</strong><p>Udaleko Segurtasun Batzordearen aurrean azaldu genuen Udalaren erantzunari eta Arartekoaren gomendioen betetze-mailari buruzko gure balorazioa.</p></div>
</div></div></div></section>
HTML;
