...
Fecha técnica: 2026-08-12. Alcance: tema `kermanentzat-prototype`, plugin editorial, MU-plugin, contenido sincronizado, suscripciones, sitemaps y navegación pública.
...
| Suscripción confirmada | Email y estados de confirmación, entrega y baja | Avisos editoriales; consentimiento | UAB Sender.lt y personas autorizadas en su cuenta | Hasta la baja; después, supresión o conservación mínima conforme al contrato validado y las obligaciones aplicables |
...
- Mantener la evidencia externa de la aprobación del 12/08/2026 y repetir la comprobación de grupo, dominio, formulario y baja antes de cualquier activación en producción. Staging usa el grupo real y conserva riesgo de envíos accidentales.
...
| Inventario y políticas versión `3.3.0` | Implementado; revisión jurídica/lingüística pendiente |
...
| Sender bloqueado por configuración y aprobación | Implementado; staging aprobado y producción separada |
| Alta, double opt-in, baja y campaña real | Parcial: alta/double opt-in comprobados; baja real y aceptación humana permanecen pendientes |
